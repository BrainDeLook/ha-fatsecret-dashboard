...
- показывает калории сверх эффективного дневного лимита скруглённой оранжевой дугой на кольце;
...
- показывает время фиксации и количество калорий при наведении на точку графика;
...
При наведении на точку графика или выборе её с клавиатуры отображается время,
когда Home Assistant зафиксировал изменение калорий. Это время обновления
сенсора: при опросе FatSecret раз в 15 минут оно может быть позже фактического
приёма пищи.
